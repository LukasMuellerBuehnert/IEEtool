// charts.js
// Importiere Chart.js ggf. global im HTML

export function renderAutarkiePie(monatlich, canvasId) {
...
export function renderEigenverbrauchPie(monatlich, canvasId) {
  const summe = monatlich.reduce((a, b) => ({
    direkt: a.direkt + b.direkt,
    speicher: a.speicher + b.speicher,
...
export function renderTagesStack(tagesprofil, canvasId) {
...
export function renderJahresStack(monatlich, canvasId) {
...
export function renderAutarkieLine(monatlich, canvasId) {
  const labels = ['Jan', 'Feb', 'Mär', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dez'];
...
export function renderJahresErtrag(monatlich, canvasId) {
  const labels = ['Jan', 'Feb', 'Mär', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dez'];
  new Chart(document.getElementById(canvasId), {
    type: 'bar',
    data: {
